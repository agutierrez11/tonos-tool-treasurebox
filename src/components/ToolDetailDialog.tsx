...
const ToolDetailDialog = ({ tool, open, onOpenChange }: ToolDetailDialogProps) => {
        ...
        <div className="space-y-5 py-4">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <div className="flex-1 min-w-[120px]">
              ...
              <div className={cn("inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg", pricing.bgColor)}>
                <PricingIcon className={cn("w-3.5 h-3.5", pricing.color)} />
                <span className={cn("text-xs font-medium", pricing.color)}>
            ...
            <div className="flex-1 min-w-[120px]">
              ...
              <div className="flex items-center gap-1.5">
                <FunnelIcon className={cn("w-4 h-4", funnel.color)} />
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-1.5">
              {tool.needs.map((need) => (
                <Badge key={need} variant="outline" className="capitalize text-xs py-0.5">
