...
export const tools: Tool[] = [
  ...
  { id: "gong", name: "Gong", description: { es: "Inteligencia de ingresos y análisis de conversaciones", en: "Revenue intelligence and conversation analytics" }, url: "https://www.gong.io/", icon: "TrendingUp", categoryId: "sales-crm", needs: ["analytics"], levels: ["senior"], pricing: "paid" },
  ...
  { id: "hubspotcrm", name: "HubSpot CRM", description: { es: "CRM gratuito con seguimiento de prospectos", en: "Free CRM with prospect tracking" }, url: "https://www.hubspot.com/products/crm", icon: "Users", categoryId: "sales-crm", needs: ["automation", "analytics", "prospecting"], levels: ["beginner", "junior", "senior"], pricing: "freemium" },
  { id: "pipedrive", name: "Pipedrive", description: { es: "CRM visual orientado a ventas", en: "Visual sales-oriented CRM" }, url: "https://www.pipedrive.com/", icon: "PieChart", categoryId: "sales-crm", needs: ["automation", "analytics"], levels: ["beginner", "junior", "senior"], pricing: "freemium" },
  { id: "salesloft", name: "SalesLoft", description: { es: "Cadencias de ventas y engagement multicanal", en: "Sales cadences and multichannel engagement" }, url: "https://www.salesloft.com/", icon: "Zap", categoryId: "sales-crm", needs: ["automation", "prospecting"], levels: ["junior", "senior"], pricing: "paid" },
  { id: "aircall", name: "Aircall", description: { es: "Sistema telefónico cloud con analytics de llamadas", en: "Cloud phone system with call analytics" }, url: "https://www.aircall.io/", icon: "Phone", categoryId: "sales-crm", needs: ["automation", "analytics"], levels: ["junior", "senior"], pricing: "paid" },
  { id: "dialpad", name: "Dialpad", description: { es: "AI para coaching en tiempo real durante llamadas", en: "AI for real-time coaching during calls" }, url: "https://www.dialpad.com/", icon: "Headphones", categoryId: "sales-crm", needs: ["automation", "analytics"], levels: ["junior", "senior"], pricing: "paid" },
  { id: "calendly", name: "Calendly", description: { es: "Agenda reuniones sin fricción", en: "Schedule meetings without friction" }, url: "https://calendly.com/", icon: "Calendar", categoryId: "sales-crm", needs: ["automation"], levels: ["beginner", "junior", "senior"], pricing: "freemium" },
  { id: "chorus", name: "Chorus.ai", description: { es: "Inteligencia de conversaciones de ventas", en: "Sales conversation intelligence" }, url: "https://www.chorus.ai/", icon: "MessageCircle", categoryId: "sales-crm", needs: ["analytics"], levels: ["senior"], pricing: "paid" },

  // Lead Generation
  { id: "lemlist", name: "Lemlist", description: { es: "Cold email y personalización con IA", en: "Cold email and AI personalization" }, url: "https://lemlist.com/", icon: "Mail", categoryId: "lead-generation", needs: ["automation", "prospecting"], levels: ["junior", "senior"], pricing: "paid" },
  { id: "linkedinsales", name: "LinkedIn Sales Navigator", description: { es: "Prospección avanzada en LinkedIn", en: "Advanced LinkedIn prospecting" }, url: "https://www.linkedin.com/sales/", icon: "Linkedin", categoryId: "lead-generation", needs: ["prospecting"], levels: ["junior", "senior"], pricing: "paid" },
