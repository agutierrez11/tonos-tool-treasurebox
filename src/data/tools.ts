...
export const tools: Tool[] = [
  ...
  // WARM-UP - Email Warmup Tools (moved from email-tools + new)
  ...
  { id: "folderly", name: "Folderly", description: { es: "Mejora la entregabilidad de emails con warm-up", en: "Improve email deliverability with warm-up" }, url: "https://folderly.com/", icon: "FolderCheck", categoryId: "warm-up", needs: ["analytics", "automation"], levels: ["senior"], pricing: "paid", funnelStage: "mofu" },
  { id: "lemwarm", name: "Lemwarm", description: { es: "Calentamiento automático de emails", en: "Automatic email warmup" }, url: "https://www.lemwarm.com/", icon: "Thermometer", categoryId: "warm-up", needs: ["automation"], levels: ["junior", "senior"], pricing: "paid", funnelStage: "mofu" },
  ...
  { id: "mailwarm", name: "Mailwarm", description: { es: "Servicio de calentamiento de emails", en: "Email warming service" }, url: "https://www.mailwarm.com/", icon: "Flame", categoryId: "warm-up", needs: ["automation"], levels: ["beginner", "junior"], pricing: "freemium", funnelStage: "mofu" },
  ...
  { id: "warmbox", name: "Warmbox", description: { es: "Calentamiento de emails con IA", en: "AI-powered email warm-up" }, url: "https://www.warmbox.ai/", icon: "Bot", categoryId: "warm-up", needs: ["automation"], levels: ["junior", "senior"], pricing: "paid", funnelStage: "mofu" },
